        ...
        ************/
        ...
        class Fireball extends Entity {
            constructor(game, x, y, img = null, ctx = null, scale = null) {
                ...
                this.boundHeight = 3*this.scale;
                this.boundX = this.centerX - this.boundWidth/2;
                this.boundY = this.y + this.spriteHeight * this.scale/2 - this.boundHeight;
                ...
                this.animations = {
                    "active": new Animation(this.img, [this.spriteWidth, this.spriteHeight], 9, 13, 5, 6, true, this.scale, 6),
                };
                this.animation = this.animations.active;
            }
