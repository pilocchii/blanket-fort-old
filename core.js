define([
    ...
    ASSET_MANAGER.downloadAll(function () {
        ...
        gameEngine.addEntity(new Entity.Hero(gameEngine, 200, 0, ASSET_MANAGER.getAsset("img/ZXe.png"), ctx));
        ...
        gameEngine.addEntity(new Entity.Terrain(gameEngine, 0, 700, null, ctx))
